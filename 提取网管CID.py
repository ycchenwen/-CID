...
hwvlan4=pd.read_csv('hwvlan@3.csv',encoding='gbk')
hwvlan5=pd.read_csv('hwvlan@4.csv',encoding='gbk')
hwvlan_df=pd.concat([hwvlan1,hwvlan2,hwvlan3,hwvlan4,hwvlan5])
...
zxvlan7=pd.read_csv('g.csv',encoding='gbk')
zxvlan_df=pd.concat([zxvlan1,zxvlan2,zxvlan3,zxvlan4,zxvlan5,zxvlan6,zxvlan7])
m=[]
for i in range(1,12):
