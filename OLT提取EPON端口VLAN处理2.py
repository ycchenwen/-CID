...
'''
根据olt name和onu_id获取mark
G2&"_框:1/"&"槽:"&MID(B2,FIND("/",B2)+1,FIND("/",B2,FIND("/",B2)+1)-FIND("/",B2)-1)&"/端口:"&MID(B2,FIND("/",B2,FIND("/",B2)+1)+1,FIND(":",B2)-FIND("/",B2,FIND("/",B2)+1)-1)&"/ONTID:"&RIGHT(B2,LEN(B2)-FIND(":",B2))
根据olt name和onu_id获取ponport
G2&"_框:1/"&"槽:"&MID(B2,FIND("/",B2)+1,FIND("/",B2,FIND("/",B2)+1)-FIND("/",B2)-1)&"/端口:"&MID(B2,FIND("/",B2,FIND("/",B2)+1)+1,FIND(":",B2)-FIND("/",B2,FIND("/",B2)+1)-1)
'''
